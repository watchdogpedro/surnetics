...
const articles = [
  {
    ...
    body: [
      ...
      "By precisely engineering surface energy gradients, fluids move at controlled rates and paths, enabling accurate and reproducible test results that are critical for both qualitative and quantitative diagnostics. Instead of relying on complex pumps, wicking structures, multiple reagent additions, or conventional hardware, the precision coatings passively control fluid movement — enabling faster, simpler, and more reliable diagnostics for at-home, point-of-care, lab-on-a-chip, and other remote testing environments. Coatings can also be used to control the flow of on-board reagents such as wash solutions or other reagent solutions that can improve the accuracy of testing or expand the number of tests a device can perform.",
      ...
      "Gradient coatings can be produced on a wide range of materials — including polymers (COC, Polyester, Acrylic, Polycarbonate, Polypropylene, Polyethylene, Nylon, Silicones), metals (Stainless Steel, Carbon Steel, Gold, Copper, Nickel, Silver, and Alloys), and silicon/glass (Silicon, Silanized Glass, Glass and Metal Oxides). Coatings have been developed for use with blood, plasma, wash solutions, and other aqueous- and organic-based reagent solutions. Separate licenses are also available for trade secret and technology transfer content including coating formulations for metal, glass, and plastic surfaces; coating processes and equipment specifications; predictive flow models and material test data for product designs; and preferred materials and coating compositions with specific liquids.",
      "About Brian Babcock: Brian Babcock is the inventor on the gradient coating technology patents. A recognized expert in coating and polymer materials, he has over 30 years of expertise with surface modification, specialty coatings, and material development across multiple industries. With deep experience in technology development, IP strategy, and commercialization, he manages the technical development efforts and patent portfolio for the surface gradient coatings and products. He is a registered patent agent with previous Intellectual Property Manager roles at Donaldson Company (filtration), SunEdison/GCL Solar Materials (solar and semiconductors), and Johnson & Johnson (life science). He holds BS and MS degrees in chemical engineering from Vanderbilt University.",
      "About Becker Transactions: Becker Transactions is a world-leading patent brokerage firm expertly led by Dean Becker and Olivia Becker, a father-daughter team who bring a rich family legacy of navigating complex intellectual property transactions. Our team has collectively facilitated over $11 billion USD in intellectual property transactions. With decades of experience collaborating with inventors, government agencies, top research institutes, universities, and major corporations, we specialize in technology monetization — identifying essential intellectual property assets and connecting them with strategic buyers seeking competitive advantages.",
    ],
  },
  {
    date: "March 2026",
